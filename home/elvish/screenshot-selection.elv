...
# # One liner
# maim -s | convert - -bordercolor '#EDD7BD' -border 4 '(' +clone -background '#575279' -shadow 60x6+3+3 ')' +swap -background none -layers merge +repage /tmp/.elvss.png; xclip -selection clipboard -t image/png /tmp/.elvss.png; rm /tmp/.elvss.png 
